...
from results.models import Movies, MovieGenres, ProductionCompanies, Keywords, Casts, Crews, SearchIndex
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        print("Search Index: {}".format(SearchIndex.objects.count()))
        print("Calibrated: {}".format(SearchIndex.objects.first().is_calibrated()))
